...
let AuthController = class AuthController {
    ...
    async loginMfa(body, req, res) {
        const meta = { ip: req.ip, userAgent: req.headers['user-agent'] };
        const result = await this.authService.completeMfaLogin(body.mfaTempToken, body.totpCode, meta);
        res.cookie('sso_session', result.sessionId, {
            httpOnly: true,
            secure: process.env.NODE_ENV === 'production',
            sameSite: 'lax',
    ...
    async verifyMfaCode(req, dto) {
        const isValid = await this.authService.verifyMfa(req.user.id, dto.token);
        if (!isValid)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "loginMfa", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, auth_dto_1.VerifyMfaDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "verifyMfaCode", null);
__decorate([
